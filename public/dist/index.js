...
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alert = require("./alert");
const stripe = Stripe('pk_test_51TxYXqJAAwABaOugPu3It6IQKBRI72ggl70q0YvooDJX3DOOR7imfi8m2cu0TigxUZ8qtw8eYRnVr3iqpGQl2PqX00f3fsuWCw');
const bookTour = async (tourId)=>{
    try {
        //1)Get checkout session from API
        const session = await (0, _axiosDefault.default)(`http://localhost:5000/api/v1/bookings/checkout-session/${tourId}`);
        console.log(session);
